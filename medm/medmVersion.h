...
#define MEDM_UPDATE_LEVEL	3

#ifdef __COLOR_RULE_H__
#define MEDM_VERSION_STRING	"MEDM(ColorRule) Version 2.3.3"
#else
#define MEDM_VERSION_STRING	"MEDM Version 2.3.3"
#endif
#define MEDM_VERSION_DIGITS	"MEDM020303"
