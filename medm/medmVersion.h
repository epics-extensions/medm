...
#define MEDM_VERSION_STRING	"MEDM(ColorRule) Version 2.3.4Beata2"
#else
#define MEDM_VERSION_STRING	"MEDM Version 2.3.4Beata2"
#endif
#define MEDM_VERSION_DIGITS	"MEDM020304Beata2"
