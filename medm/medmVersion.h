...
#define MEDM_VERSION_STRING	"MEDM(ColorRule) Version 2.3.4Beta1"
#else
#define MEDM_VERSION_STRING	"MEDM Version 2.3.4Beta1"
#endif
#define MEDM_VERSION_DIGITS	"MEDM020304Beta1"
