 ...
 * .40  09-22-06        evans   3.1.0 release
...
#define MEDM_MODIFICATION	8
#define MEDM_PATCH_LEVEL	1
#define MEDM_VERSION_STRING	"MEDM Version 3.1.8.1"
#define MEDM_VERSION_DIGITS	"MEDM030108"
