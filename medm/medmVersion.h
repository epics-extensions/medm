...
#define MEDM_VERSION_STRING	"MEDM(ColorRule) Version 2.3.5Beta3"
#else
#define MEDM_VERSION_STRING	"MEDM Version 2.3.5Beta3"
#endif
#define MEDM_VERSION_DIGITS	"MEDM020305Beta3"
