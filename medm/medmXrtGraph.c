...
#endif
  nargs = 0;
  XtSetArg(args[nargs], XmNuserData, userData);
  nargs++;
  XtSetArg(args[nargs], XtNxrtXAnnotationMethod, &xAnnoMethod);
  nargs++;
  XtSetArg(args[nargs], XtNxrtXAxisLogarithmic, xAxisIsLog);
  nargs++;
  XtSetArg(args[nargs], XtNxrtYAxisLogarithmic, yAxisIsLog);
  nargs++;
  XtSetArg(args[nargs], XtNxrtY2AxisLogarithmic, y2AxisIsLog);
  nargs++;
  XtSetArg(args[nargs], XtNxrtXMin, &xMin);
  nargs++;
  XtSetArg(args[nargs], XtNxrtYMin, &yMin);
  nargs++;
  XtSetArg(args[nargs], XtNxrtY2Min, &y2Min);
  nargs++;
  XtSetArg(args[nargs], XtNxrtXMax, &xMax);
  nargs++;
  XtSetArg(args[nargs], XtNxrtYMax, &yMax);
  nargs++;
  XtSetArg(args[nargs], XtNxrtY2Max, &y2Max);
  nargs++;
  /* Axis is auto if using default for (min and max) */
  XtSetArg(args[nargs], XtNxrtXMinUseDefault, xAxisIsAuto);
  nargs++;
  XtSetArg(args[nargs], XtNxrtYMinUseDefault, yAxisIsAuto);
  nargs++;
  XtSetArg(args[nargs], XtNxrtY2MinUseDefault, y2AxisIsAuto);
  nargs++;
  XtSetArg(args[nargs], XtNxrtTimeFormat, timeFormat);
  nargs++;
...
void CpGetAxisMaxMin(Widget w, int axis, XcVType *maxF, XcVType *minF)
{
  ...
  switch (axis)
    {
    case CP_X:
      XtSetArg(args[nargs], XtNxrtXMax, &max);
      nargs++;
      XtSetArg(args[nargs], XtNxrtXMin, &min);
      nargs++;
      break;
    case CP_Y:
      XtSetArg(args[nargs], XtNxrtYMax, &max);
      nargs++;
      XtSetArg(args[nargs], XtNxrtYMin, &min);
      nargs++;
      break;
    case CP_Y2:
      XtSetArg(args[nargs], XtNxrtY2Max, &max);
      nargs++;
      XtSetArg(args[nargs], XtNxrtY2Min, &min);
      nargs++;
      break;
    }
  XtGetValues(w, args, nargs);
...
/* hData is unused */
{
  ...
  if (lineType == CP_LINE_NONE)
    myds.lpat = XRT_LPAT_NONE;
  else
    myds.lpat = XRT_LPAT_SOLID;
  if (fillType == CP_LINE_NONE)
    myds.fpat = XRT_FPAT_NONE;
  else
    myds.fpat = XRT_FPAT_SOLID;
  myds.color = rgb;
  myds.width = 1;
  ...
  if (Yaxis == 0)
    XrtSetNthDataStyle(w, iYaxis, &myds);
  else
    XrtSetNthDataStyle2(w, iYaxis, &myds);
}
                  ...
                  XcVType tick, XcVType num, int precision)
{
  ...
  switch (axis)
    {
    case CP_X:
      XtSetArg(args[nargs], XtNxrtXMax, XrtFloatToArgVal(max.fval));
      nargs++;
      XtSetArg(args[nargs], XtNxrtXMin, XrtFloatToArgVal(min.fval));
      nargs++;
      XtSetArg(args[nargs], XtNxrtXTick, XrtFloatToArgVal(tick.fval));
      nargs++;
      XtSetArg(args[nargs], XtNxrtXNum, XrtFloatToArgVal(num.fval));
      nargs++;
      XtSetArg(args[nargs], XtNxrtXPrecision, precision);
      nargs++;
      break;
    case CP_Y:
      XtSetArg(args[nargs], XtNxrtYMax, XrtFloatToArgVal(max.fval));
      nargs++;
      XtSetArg(args[nargs], XtNxrtYMin, XrtFloatToArgVal(min.fval));
      nargs++;
      XtSetArg(args[nargs], XtNxrtYTick, XrtFloatToArgVal(tick.fval));
      nargs++;
      XtSetArg(args[nargs], XtNxrtYNum, XrtFloatToArgVal(num.fval));
      nargs++;
      XtSetArg(args[nargs], XtNxrtYPrecision, precision);
      nargs++;
      break;
    case CP_Y2:
      XtSetArg(args[nargs], XtNxrtY2Max, XrtFloatToArgVal(max.fval));
      nargs++;
      XtSetArg(args[nargs], XtNxrtY2Min, XrtFloatToArgVal(min.fval));
      nargs++;
      XtSetArg(args[nargs], XtNxrtY2Tick, XrtFloatToArgVal(tick.fval));
      nargs++;
      XtSetArg(args[nargs], XtNxrtY2Num, XrtFloatToArgVal(num.fval));
      nargs++;
      XtSetArg(args[nargs], XtNxrtY2Precision, precision);
      nargs++;
      break;
    }
...
void CpSetAxisAuto(Widget w, int axis)
{
  ...
  switch (axis)
    {
    case CP_X:
      XtSetArg(args[nargs], XtNxrtXMaxUseDefault, True);
      nargs++;
      XtSetArg(args[nargs], XtNxrtXMinUseDefault, True);
      nargs++;
      XtSetArg(args[nargs], XtNxrtXTickUseDefault, True);
      nargs++;
      XtSetArg(args[nargs], XtNxrtXNumUseDefault, True);
      nargs++;
      XtSetArg(args[nargs], XtNxrtXPrecisionUseDefault, True);
      nargs++;
      break;
    case CP_Y:
      XtSetArg(args[nargs], XtNxrtYMaxUseDefault, True);
      nargs++;
      XtSetArg(args[nargs], XtNxrtYMinUseDefault, True);
      nargs++;
      XtSetArg(args[nargs], XtNxrtYTickUseDefault, True);
      nargs++;
      XtSetArg(args[nargs], XtNxrtYNumUseDefault, True);
      nargs++;
      XtSetArg(args[nargs], XtNxrtYPrecisionUseDefault, True);
      nargs++;
      break;
    case CP_Y2:
      XtSetArg(args[nargs], XtNxrtY2MaxUseDefault, True);
      nargs++;
      XtSetArg(args[nargs], XtNxrtY2MinUseDefault, True);
      nargs++;
      XtSetArg(args[nargs], XtNxrtY2TickUseDefault, True);
      nargs++;
      XtSetArg(args[nargs], XtNxrtY2NumUseDefault, True);
      nargs++;
      XtSetArg(args[nargs], XtNxrtY2PrecisionUseDefault, True);
      nargs++;
      break;
    }
  XtSetValues(w, args, nargs);
...
void CpSetAxisLinear(Widget w, int axis)
{
  ...
  switch (axis)
    {
    case CP_X:
      XtSetArg(args[nargs], XtNxrtXAnnotationMethod, XRT_ANNO_VALUES);
      nargs++;
      XtSetArg(args[nargs], XtNxrtXAxisLogarithmic, False);
      nargs++;
      break;
    case CP_Y:
      XtSetArg(args[nargs], XtNxrtYAxisLogarithmic, False);
      nargs++;
      break;
    case CP_Y2:
      XtSetArg(args[nargs], XtNxrtY2AxisLogarithmic, False);
      nargs++;
      break;
    }
  XtSetValues(w, args, nargs);
...
void CpSetAxisLog(Widget w, int axis)
{
  ...
  switch (axis)
    ...
    case CP_X:
      XtSetArg(args[nargs], XtNxrtXAnnotationMethod, XRT_ANNO_VALUES);
      nargs++;
      XtSetArg(args[nargs], XtNxrtXAxisLogarithmic, True);
      nargs++;
      break;
    case CP_Y:
      XtSetArg(args[nargs], XtNxrtYAxisLogarithmic, True);
      nargs++;
      break;
    case CP_Y2:
      XtSetArg(args[nargs], XtNxrtY2AxisLogarithmic, True);
      nargs++;
      break;
    }
  XtSetValues(w, args, nargs);
...
void CpSetAxisTime(Widget w, int axis, time_t base, char *format)
{
  ...
  switch (axis)
    ...
    case CP_X:
      XtSetArg(args[nargs], XtNxrtXAxisLogarithmic, False);
      nargs++;
      XtSetArg(args[nargs], XtNxrtXAnnotationMethod, XRT_ANNO_TIME_LABELS);
      nargs++;
      XtSetArg(args[nargs], XtNxrtTimeBase, base);
      nargs++;
      XtSetArg(args[nargs], XtNxrtTimeUnit, XRT_TMUNIT_SECONDS);
      nargs++;
      XtSetArg(args[nargs], XtNxrtTimeFormatUseDefault, False);
      nargs++;
      XtSetArg(args[nargs], XtNxrtTimeFormat, format);
      nargs++;
      break;
    }
  XtSetValues(w, args, nargs);
...
void CpSetData(Widget w, int axis, CpDataHandle hData)
{
  ...
  if (axis == CP_Y)
    {
      XtSetArg(args[nargs], XtNxrtData, hData);
      nargs++;
    }
  else
    {
      XtSetArg(args[nargs], XtNxrtData2, hData);
      nargs++;
    }
  XtSetValues(w, args, nargs);
}
...
void CpEraseData(Widget w, int axis, CpDataHandle hData)
{
  ...
  if (axis == CP_Y)
    {
      XtSetArg(args[nargs], XtNxrtData, hcpNullData);
      nargs++;
    }
  else
    {
      XtSetArg(args[nargs], XtNxrtData2, hcpNullData);
      nargs++;
    }
  XtSetValues(w, args, nargs);
}
                             ...
                             DlCartesianPlot *dlCartesianPlot, MedmCartesianPlot *pcp)
{
...
#if 1
  {
    ...
    XtSetArg(args[nargs], XmNtopShadowColor, BlackPixel(display, screenNum));
    nargs++;
    XtSetArg(args[nargs], XmNbottomShadowColor, bottomShadow);
    nargs++;
    XtSetArg(args[nargs], XmNselectColor, select);
    nargs++;
  }
#endif
  ...
  sprintf(rgb[1], "#%2.2x%2.2x%2.2x", xColors[1].red >> 8, xColors[1].green >> 8,
          xColors[1].blue >> 8);
  XtSetArg(args[nargs], XtNxrtGraphForegroundColor, rgb[0]);
  nargs++;
  XtSetArg(args[nargs], XtNxrtGraphBackgroundColor, rgb[1]);
  nargs++;
  XtSetArg(args[nargs], XtNxrtForegroundColor, rgb[0]);
  nargs++;
  XtSetArg(args[nargs], XtNxrtBackgroundColor, rgb[1]);
  nargs++;
...
#if XRT_VERSION > 2
  XtSetArg(args[nargs], XtNxrtHeaderFont, fontListTable[bestSize]);
  nargs++;
#else
  XtSetArg(args[nargs], XtNxrtHeaderFont, fontTable[bestSize]->fid);
  nargs++;
#endif
  ...
  XtSetArg(args[nargs], XtNxrtHeaderStrings, headerStrings);
  nargs++;
  if (strlen(dlCartesianPlot->plotcom.xlabel) > 0)
    {
      XtSetArg(args[nargs], XtNxrtXTitle, dlCartesianPlot->plotcom.xlabel);
      nargs++;
    }
  else
    {
      XtSetArg(args[nargs], XtNxrtXTitle, NULL);
      nargs++;
    }
  if (strlen(dlCartesianPlot->plotcom.ylabel) > 0)
    {
      XtSetArg(args[nargs], XtNxrtYTitle, dlCartesianPlot->plotcom.ylabel);
      nargs++;
    }
  else
    {
      XtSetArg(args[nargs], XtNxrtYTitle, NULL);
      nargs++;
    }
  preferredHeight = MIN(dlCartesianPlot->object.width,
                        dlCartesianPlot->object.height) /
  ...
  bestSize = dmGetBestFontWithInfo(fontTable, MAX_FONTS, NULL,
                                   preferredHeight, 0, &usedHeight, &usedCharWidth, FALSE);
#if XRT_VERSION > 2
  XtSetArg(args[nargs], XtNxrtAxisFont, fontListTable[bestSize]);
  nargs++;
#else
  XtSetArg(args[nargs], XtNxrtAxisFont, fontTable[bestSize]->fid);
  nargs++;
#endif
  switch (dlCartesianPlot->style)
    ...
    case POINT_PLOT:
    case LINE_PLOT:
      XtSetArg(args[nargs], XtNxrtType, XRT_PLOT);
      nargs++;
      if (validTraces > 1)
        {
          XtSetArg(args[nargs], XtNxrtType2, XRT_PLOT);
          nargs++;
        }
      break;
    case FILL_UNDER_PLOT:
      XtSetArg(args[nargs], XtNxrtType, XRT_AREA);
      nargs++;
      if (validTraces > 1)
        {
          XtSetArg(args[nargs], XtNxrtType2, XRT_AREA);
          nargs++;
        }
      break;
    }
  if (validTraces > 1)
    {
      XtSetArg(args[nargs], XtNxrtY2AxisShow, TRUE);
      nargs++;
    }
    ...
    case TIME_AXIS:
      {
        ...
        XtSetArg(args[nargs], XtNxrtXAnnotationMethod, XRT_ANNO_TIME_LABELS);
        nargs++;
        XtSetArg(args[nargs], XtNxrtTimeBase, time900101);
        nargs++;
        XtSetArg(args[nargs], XtNxrtTimeUnit, XRT_TMUNIT_SECONDS);
        nargs++;
        XtSetArg(args[nargs], XtNxrtTimeFormatUseDefault, False);
  ...
  switch (dlCartesianPlot->axis[X_AXIS_ELEMENT].rangeStyle)
    ...
    case USER_SPECIFIED_RANGE:
      ...
      XtSetArg(args[nargs], XtNxrtXMin, XrtFloatToArgVal(minF.fval));
      nargs++;
      XtSetArg(args[nargs], XtNxrtXMax, XrtFloatToArgVal(maxF.fval));
      nargs++;
      XtSetArg(args[nargs], XtNxrtXTick, XrtFloatToArgVal(tickF.fval));
      nargs++;
      XtSetArg(args[nargs], XtNxrtXNum, XrtFloatToArgVal(tickF.fval));
      nargs++;
      ...
      while (string[k] != '.' && k >= 0)
        k--;
      iPrec = iPrec - k;
      XtSetArg(args[nargs], XtNxrtXPrecision, iPrec);
      nargs++;
      break;
    default:
  ...
  switch (dlCartesianPlot->axis[Y1_AXIS_ELEMENT].rangeStyle)
    ...
    case USER_SPECIFIED_RANGE:
      ...
      tickF.fval = (maxF.fval - minF.fval) / 4.0;
      XtSetArg(args[nargs], XtNxrtYMin, XrtFloatToArgVal(minF.fval));
      nargs++;
      XtSetArg(args[nargs], XtNxrtYMax, XrtFloatToArgVal(maxF.fval));
      nargs++;
      XtSetArg(args[nargs], XtNxrtYTick, XrtFloatToArgVal(tickF.fval));
      nargs++;
      XtSetArg(args[nargs], XtNxrtYNum, XrtFloatToArgVal(tickF.fval));
      nargs++;
      sprintf(string, "%f", tickF.fval);
      k = strlen(string) - 1;
      while (string[k] == '0')
      ...
      while (string[k] != '.' && k >= 0)
        k--;
      iPrec = iPrec - k;
      XtSetArg(args[nargs], XtNxrtYPrecision, iPrec);
      nargs++;
      break;
    default:
  ...
  switch (dlCartesianPlot->axis[Y2_AXIS_ELEMENT].rangeStyle)
    ...
    case USER_SPECIFIED_RANGE:
      ...
      tickF.fval = (maxF.fval - minF.fval) / 4.0;
      XtSetArg(args[nargs], XtNxrtY2Min, XrtFloatToArgVal(minF.fval));
      nargs++;
      XtSetArg(args[nargs], XtNxrtY2Max, XrtFloatToArgVal(maxF.fval));
      nargs++;
      XtSetArg(args[nargs], XtNxrtY2Tick, XrtFloatToArgVal(tickF.fval));
      nargs++;
      XtSetArg(args[nargs], XtNxrtY2Num, XrtFloatToArgVal(tickF.fval));
      nargs++;
      sprintf(string, "%f", tickF.fval);
      k = strlen(string) - 1;
      while (string[k] == '0')
      ...
      while (string[k] != '.' && k >= 0)
        k--;
      iPrec = iPrec - k;
      XtSetArg(args[nargs], XtNxrtY2Precision, iPrec);
      nargs++;
      break;
    default:
      medmPrintf(1,
  ...
  XtSetArg(args[nargs], XtNxrtGraphShowOutlines, False);
  nargs++;

  /* Set miscellaneous args */
  XtSetArg(args[nargs], XmNtraversalOn, False);
  nargs++;
  XtSetArg(args[nargs], XtNxrtDoubleBuffer, True);
  nargs++;
...
void dumpCartesianPlot(Widget w)
{
  ...
  XtSetArg(args[n], XtNxrtLegendWidth, &legendWidth);
  n++;
  XtSetArg(args[n], XtNxrtLegendHeight, &legendHeight);
  n++;
  XtSetArg(args[n], XtNxrtLegendBorderWidth, &legendBorderWidth);
  n++;
  XtSetArg(args[n], XmNwidth, &width);
  n++;
  XtSetArg(args[n], XmNheight, &height);
  n++;
  XtSetArg(args[n], XtNxrtGraphBorderWidth, &graphBorderWidth);
  n++;
  XtSetArg(args[n], XtNxrtGraphWidth, &graphWidth);
  n++;
  XtSetArg(args[n], XtNxrtGraphHeight, &graphHeight);
  n++;
  XtSetArg(args[n], XtNxrtHeaderWidth, &headerWidth);
  n++;
  XtSetArg(args[n], XtNxrtHeaderHeight, &headerHeight);
  n++;
  XtSetArg(args[n], XtNxrtHeaderBorderWidth, &headerBorderWidth);
  n++;
  XtSetArg(args[n], XmNhighlightThickness, &highlightThickness);
  n++;
  XtSetArg(args[n], XmNshadowThickness, &shadowThickness);
  n++;
  XtSetArg(args[n], XmNborderWidth, &borderWidth);
  n++;
  XtSetArg(args[n], XtNxrtFooterBorderWidth, &footerBorderWidth);
  n++;
  XtSetArg(args[n], XtNxrtFooterHeight, &footerHeight);
  n++;
  XtSetArg(args[n], XtNxrtFooterWidth, &footerWidth);
  n++;
  XtSetArg(args[n], XtNxrtFooterBorderWidth, &footerBorderWidth);
  n++;
  XtSetArg(args[n], XmNunitType, &unitType);
  n++;
  XtSetArg(args[n], XtNxrtTimeBase, &timeBase);
  n++;
