                   ...
                   XcVType *xMinF, XcVType *yMinF, XcVType *y2MinF)
{
  ...
  nargs++;
  XtSetArg(args[nargs], XtNplotXAnnotationMethod, &xAnnoMethod);
  nargs++;
  XtSetArg(args[nargs], XtNplotXAxisLogarithmic, xAxisIsLog);
  nargs++;
  XtSetArg(args[nargs], XtNplotYAxisLogarithmic, yAxisIsLog);
  nargs++;
  XtSetArg(args[nargs], XtNplotY2AxisLogarithmic, y2AxisIsLog);
  nargs++;
  XtSetArg(args[nargs], XtNplotXMin, &xMin);
  nargs++;
  XtSetArg(args[nargs], XtNplotYMin, &yMin);
  nargs++;
  XtSetArg(args[nargs], XtNplotY2Min, &y2Min);
  nargs++;
  XtSetArg(args[nargs], XtNplotXMax, &xMax);
  nargs++;
  XtSetArg(args[nargs], XtNplotYMax, &yMax);
  nargs++;
  XtSetArg(args[nargs], XtNplotY2Max, &y2Max);
  nargs++;
  /* Axis is auto if using default for (min and max) */
  XtSetArg(args[nargs], XtNplotXMinUseDefault, xAxisIsAuto);
  nargs++;
  XtSetArg(args[nargs], XtNplotYMinUseDefault, yAxisIsAuto);
  nargs++;
  XtSetArg(args[nargs], XtNplotY2MinUseDefault, y2AxisIsAuto);
  nargs++;
  XtSetArg(args[nargs], XtNplotTimeFormat, timeFormat);
  nargs++;
...
void CpGetAxisMaxMin(Widget w, int axis, XcVType *maxF, XcVType *minF)
{
  ...
  switch (axis)
    {
    case CP_X:
      XtSetArg(args[nargs], XtNplotXMax, &max);
      nargs++;
      XtSetArg(args[nargs], XtNplotXMin, &min);
      nargs++;
      break;
    case CP_Y:
      XtSetArg(args[nargs], XtNplotYMax, &max);
      nargs++;
      XtSetArg(args[nargs], XtNplotYMin, &min);
      nargs++;
      break;
    case CP_Y2:
      XtSetArg(args[nargs], XtNplotY2Max, &max);
      nargs++;
      XtSetArg(args[nargs], XtNplotY2Min, &min);
      nargs++;
      break;
    }
  XtGetValues(w, args, nargs);
...
/* hData, Yaxis, nYaxis are unused */
{
  ...
  if (lineType == CP_LINE_NONE)
    myds.lpat = AtLineNONE;
  else
    myds.lpat = AtLineSOLID;
  if (fillType == CP_LINE_NONE)
    myds.fpat = PLOT_FPAT_NONE;
  else
    myds.fpat = PLOT_FPAT_SOLID;
  myds.color = rgb;
  myds.width = 1;
                  ...
                  XcVType tick, XcVType num, int precision)
{
  ...
  switch (axis)
    {
    case CP_X:
      XtSetArg(args[nargs], XtNplotXMax, max.lval);
      nargs++;
      XtSetArg(args[nargs], XtNplotXMin, min.lval);
      nargs++;
      XtSetArg(args[nargs], XtNplotXTick, tick.lval);
      nargs++;
      XtSetArg(args[nargs], XtNplotXNum, num.lval);
      nargs++;
      XtSetArg(args[nargs], XtNplotXPrecision, precision);
      nargs++;
      break;
    case CP_Y:
      XtSetArg(args[nargs], XtNplotYMax, max.lval);
      nargs++;
      XtSetArg(args[nargs], XtNplotYMin, min.lval);
      nargs++;
      XtSetArg(args[nargs], XtNplotYTick, tick.lval);
      nargs++;
      XtSetArg(args[nargs], XtNplotYNum, num.lval);
      nargs++;
      XtSetArg(args[nargs], XtNplotYPrecision, precision);
      nargs++;
      break;
    case CP_Y2:
      XtSetArg(args[nargs], XtNplotY2Max, max.lval);
      nargs++;
      XtSetArg(args[nargs], XtNplotY2Min, min.lval);
      nargs++;
      XtSetArg(args[nargs], XtNplotY2Tick, tick.lval);
      nargs++;
      XtSetArg(args[nargs], XtNplotY2Num, num.lval);
      nargs++;
      XtSetArg(args[nargs], XtNplotY2Precision, precision);
      nargs++;
      break;
    }
...
void CpSetAxisAuto(Widget w, int axis)
{
  ...
  switch (axis)
    {
    case CP_X:
      XtSetArg(args[nargs], XtNplotXMaxUseDefault, True);
      nargs++;
      XtSetArg(args[nargs], XtNplotXMinUseDefault, True);
      nargs++;
      XtSetArg(args[nargs], XtNplotXTickUseDefault, True);
      nargs++;
      XtSetArg(args[nargs], XtNplotXNumUseDefault, True);
      nargs++;
      XtSetArg(args[nargs], XtNplotXPrecisionUseDefault, True);
      nargs++;
      break;
    case CP_Y:
      XtSetArg(args[nargs], XtNplotYMaxUseDefault, True);
      nargs++;
      XtSetArg(args[nargs], XtNplotYMinUseDefault, True);
      nargs++;
      XtSetArg(args[nargs], XtNplotYTickUseDefault, True);
      nargs++;
      XtSetArg(args[nargs], XtNplotYNumUseDefault, True);
      nargs++;
      XtSetArg(args[nargs], XtNplotYPrecisionUseDefault, True);
      nargs++;
      break;
    case CP_Y2:
      XtSetArg(args[nargs], XtNplotY2MaxUseDefault, True);
      nargs++;
      XtSetArg(args[nargs], XtNplotY2MinUseDefault, True);
      nargs++;
      XtSetArg(args[nargs], XtNplotY2TickUseDefault, True);
      nargs++;
      XtSetArg(args[nargs], XtNplotY2NumUseDefault, True);
      nargs++;
      XtSetArg(args[nargs], XtNplotY2PrecisionUseDefault, True);
      nargs++;
      break;
    }
  XtSetValues(w, args, nargs);
...
void CpSetAxisLinear(Widget w, int axis)
{
  ...
  switch (axis)
    {
    case CP_X:
      XtSetArg(args[nargs], XtNplotXAnnotationMethod, PLOT_ANNO_VALUES);
      nargs++;
      XtSetArg(args[nargs], XtNplotXAxisLogarithmic, False);
      nargs++;
      break;
    case CP_Y:
      XtSetArg(args[nargs], XtNplotYAxisLogarithmic, False);
      nargs++;
      break;
    case CP_Y2:
      XtSetArg(args[nargs], XtNplotY2AxisLogarithmic, False);
      nargs++;
      break;
    }
  XtSetValues(w, args, nargs);
...
void CpSetAxisLog(Widget w, int axis)
{
  ...
  switch (axis)
    ...
    case CP_X:
      XtSetArg(args[nargs], XtNplotXAnnotationMethod, PLOT_ANNO_VALUES);
      nargs++;
      XtSetArg(args[nargs], XtNplotXAxisLogarithmic, True);
      nargs++;
      break;
    case CP_Y:
      XtSetArg(args[nargs], XtNplotYAxisLogarithmic, True);
      nargs++;
      break;
    case CP_Y2:
      XtSetArg(args[nargs], XtNplotY2AxisLogarithmic, True);
      nargs++;
      break;
    }
  XtSetValues(w, args, nargs);
...
void CpSetAxisTime(Widget w, int axis, time_t base, char *format)
{
  ...
  switch (axis)
    ...
    case CP_X:
      XtSetArg(args[nargs], XtNplotXAxisLogarithmic, False);
      nargs++;
      XtSetArg(args[nargs], XtNplotXAnnotationMethod, PLOT_ANNO_TIME_LABELS);
      nargs++;
      XtSetArg(args[nargs], XtNplotTimeBase, base);
      nargs++;
      XtSetArg(args[nargs], XtNplotTimeUnit, PLOT_TMUNIT_SECONDS);
      nargs++;
      XtSetArg(args[nargs], XtNplotTimeFormatUseDefault, False);
      nargs++;
      XtSetArg(args[nargs], XtNplotTimeFormat, format);
      nargs++;
      break;
    }
  XtSetValues(w, args, nargs);
...
void CpSetData(Widget w, int axis, CpDataHandle hData)
{
  ...
  if (axis == CP_Y)
    {
      XtSetArg(args[nargs], XtNplotData, hData);
      nargs++;
    }
  else
    {
      XtSetArg(args[nargs], XtNplotData2, hData);
      nargs++;
    }
  XtSetValues(w, args, nargs);
}
...
void CpEraseData(Widget w, int axis, CpDataHandle hData)
{
  ...
  if (axis == CP_Y)
    {
      XtSetArg(args[nargs], XtNplotData, hcpNullData);
      nargs++;
    }
  else
    {
      XtSetArg(args[nargs], XtNplotData2, hcpNullData);
      nargs++;
    }
  XtSetValues(w, args, nargs);
}
                             ...
                             DlCartesianPlot *dlCartesianPlot, MedmCartesianPlot *pcp)
{
  ...
  sprintf(rgb[1], "#%2.2x%2.2x%2.2x", xColors[1].red >> 8, xColors[1].green >> 8,
          xColors[1].blue >> 8);
  XtSetArg(args[nargs], XtNplotGraphForegroundColor, rgb[0]);
  nargs++;
  XtSetArg(args[nargs], XtNplotGraphBackgroundColor, rgb[1]);
  nargs++;
  XtSetArg(args[nargs], XtNplotForegroundColor, rgb[0]);
  nargs++;
  XtSetArg(args[nargs], XtNplotBackgroundColor, rgb[1]);
  nargs++;
  ...
  XtSetArg(args[nargs], XtNplotHeaderFont, fontTable[bestSize]->fid);
  nargs++;
  ...
  XtSetArg(args[nargs], XtNplotHeaderStrings, headerStrings);
  nargs++;
  if (strlen(dlCartesianPlot->plotcom.xlabel) > 0)
    {
      XtSetArg(args[nargs], XtNplotXTitle, dlCartesianPlot->plotcom.xlabel);
      nargs++;
    }
  else
    {
      XtSetArg(args[nargs], XtNplotXTitle, NULL);
      nargs++;
    }
  if (strlen(dlCartesianPlot->plotcom.ylabel) > 0)
    {
      XtSetArg(args[nargs], XtNplotYTitle, dlCartesianPlot->plotcom.ylabel);
      nargs++;
    }
  else
    {
      XtSetArg(args[nargs], XtNplotYTitle, NULL);
      nargs++;
    }
  preferredHeight = MIN(dlCartesianPlot->object.width,
                        dlCartesianPlot->object.height) /
  ...
  bestSize = dmGetBestFontWithInfo(fontTable, MAX_FONTS, NULL,
                                   preferredHeight, 0, &usedHeight, &usedCharWidth, FALSE);
  XtSetArg(args[nargs], XtNplotAxisFont, fontTable[bestSize]->fid);
  nargs++;
  switch (dlCartesianPlot->style)
    {
    case POINT_PLOT:
    case LINE_PLOT:
      XtSetArg(args[nargs], XtNplotType, PLOT_PLOT);
      nargs++;
      if (validTraces > 1)
        {
          XtSetArg(args[nargs], XtNplotType2, PLOT_PLOT);
          nargs++;
        }
      break;
    case FILL_UNDER_PLOT:
      XtSetArg(args[nargs], XtNplotType, PLOT_AREA);
      nargs++;
      if (validTraces > 1)
        {
          XtSetArg(args[nargs], XtNplotType2, PLOT_AREA);
          nargs++;
        }
      break;
    }
  if (validTraces > 1)
    {
      XtSetArg(args[nargs], XtNplotY2AxisShow, TRUE);
      nargs++;
    }
    ...
    case TIME_AXIS:
      {
        ...
        XtSetArg(args[nargs], XtNplotXAnnotationMethod, PLOT_ANNO_TIME_LABELS);
        nargs++;
        XtSetArg(args[nargs], XtNplotTimeBase, time900101);
        nargs++;
        XtSetArg(args[nargs], XtNplotTimeUnit, PLOT_TMUNIT_SECONDS);
        nargs++;
        XtSetArg(args[nargs], XtNplotTimeFormatUseDefault, False);
  ...
  switch (dlCartesianPlot->axis[X_AXIS_ELEMENT].rangeStyle)
    ...
    case USER_SPECIFIED_RANGE:
      ...
      XtSetArg(args[nargs], XtNplotXMin, minF.lval);
      nargs++;
      XtSetArg(args[nargs], XtNplotXMax, maxF.lval);
      nargs++;
      XtSetArg(args[nargs], XtNplotXTick, tickF.lval);
      nargs++;
      XtSetArg(args[nargs], XtNplotXNum, tickF.lval);
      nargs++;
      ...
      while (string[k] != '.' && k >= 0)
        k--;
      iPrec = iPrec - k;
      XtSetArg(args[nargs], XtNplotXPrecision, iPrec);
      nargs++;
      break;
    default:
  ...
  switch (dlCartesianPlot->axis[Y1_AXIS_ELEMENT].rangeStyle)
    ...
    case USER_SPECIFIED_RANGE:
      ...
      tickF.fval = (float)((maxF.fval - minF.fval) / 4.0);
      XtSetArg(args[nargs], XtNplotYMin, minF.lval);
      nargs++;
      XtSetArg(args[nargs], XtNplotYMax, maxF.lval);
      nargs++;
      XtSetArg(args[nargs], XtNplotYTick, tickF.lval);
      nargs++;
      XtSetArg(args[nargs], XtNplotYNum, tickF.lval);
      nargs++;
      sprintf(string, "%f", tickF.fval);
      k = strlen(string) - 1;
      while (string[k] == '0')
      ...
      while (string[k] != '.' && k >= 0)
        k--;
      iPrec = iPrec - k;
      XtSetArg(args[nargs], XtNplotYPrecision, iPrec);
      nargs++;
      break;
    default:
  ...
  switch (dlCartesianPlot->axis[Y2_AXIS_ELEMENT].rangeStyle)
    ...
    case USER_SPECIFIED_RANGE:
      ...
      tickF.fval = (float)((maxF.fval - minF.fval) / 4.0);
      XtSetArg(args[nargs], XtNplotY2Min, minF.lval);
      nargs++;
      XtSetArg(args[nargs], XtNplotY2Max, maxF.lval);
      nargs++;
      XtSetArg(args[nargs], XtNplotY2Tick, tickF.lval);
      nargs++;
      XtSetArg(args[nargs], XtNplotY2Num, tickF.lval);
      nargs++;
      sprintf(string, "%f", tickF.fval);
      k = strlen(string) - 1;
      while (string[k] == '0')
      ...
      while (string[k] != '.' && k >= 0)
        k--;
      iPrec = iPrec - k;
      XtSetArg(args[nargs], XtNplotY2Precision, iPrec);
      nargs++;
      break;
    default:
      medmPrintf(1,
  ...
  XtSetArg(args[nargs], XtNplotGraphShowOutlines, False);
  nargs++;

  /* Set miscellaneous args */
  XtSetArg(args[nargs], XmNtraversalOn, False);
  nargs++;
  XtSetArg(args[nargs], XtNplotDoubleBuffer, True);
  nargs++;
...
void dumpCartesianPlot(Widget w)
{
  ...
  XtSetArg(args[n], XtNplotLegendWidth, &legendWidth);
  n++;
  /*XtSetArg(args[n],XtNplotLegendHeight,&legendHeight); n++;*/
  XtSetArg(args[n], XtNplotLegendBorderWidth, &legendBorderWidth);
  n++;
  XtSetArg(args[n], XmNwidth, &width);
  n++;
  XtSetArg(args[n], XmNheight, &height);
  n++;
  XtSetArg(args[n], XtNplotGraphBorderWidth, &graphBorderWidth);
  n++;
  /*XtSetArg(args[n],XtNplotGraphWidth,&graphWidth); n++;
    XtSetArg(args[n],XtNplotGraphHeight,&graphHeight); n++;*/
  XtSetArg(args[n], XtNplotHeaderWidth, &headerWidth);
  n++;
  XtSetArg(args[n], XtNplotHeaderHeight, &headerHeight);
  n++;
  XtSetArg(args[n], XtNplotHeaderBorderWidth, &headerBorderWidth);
  n++;
  ...
  XtSetArg(args[n], XtNplotTimeBase, &timeBase);
  n++;
