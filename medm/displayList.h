...
#define NUM_CARTESIAN_PLOT_STYLES 4
typedef enum
  {
    POINT_PLOT = 44,
    LINE_PLOT = 45,
...
typedef enum
  {
    PV_LIMITS_CHANNEL = 76,
    PV_LIMITS_DEFAULT = 77,
    PV_LIMITS_USER = 78,
    PV_LIMITS_UNUSED = 79
  } PvLimitsSrc_t;
#if defined(ALLOCATE_STORAGE) || defined(__cplusplus)
...
#define NUMBER_STRING_VALUES 84 /* Y4+1 */
...
typedef struct
{
  ...
  DlPlotAxisDefinition axis[5]; /* x = 0, y = 1, y2 = 2, y3 = 3, y4 = 4 */
...
#define Y3_AXIS_ELEMENT 3
#define Y4_AXIS_ELEMENT 4
