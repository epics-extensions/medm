...
typedef enum
  {
    COMPOSITE_NEW = 0,
    COMPOSITE_VISIBLE,
    COMPOSITE_VISIBLE_UPDATED,
    COMPOSITE_HIDDEN,
    COMPOSITE_HIDDEN_UPDATED
...
typedef struct _ResourceBundle
{
  ...
  char y2label[MAX_TOKEN_LENGTH];
  char y3label[MAX_TOKEN_LENGTH];
  char y4label[MAX_TOKEN_LENGTH];
  int clr;
  int bclr;
  int begin;
  int path;
  ...
  /* X_AXIS_ELEMENT, Y1_AXIS_ELEMENT, Y2_AXIS_ELEMENT, Y3_AXIS_ELEMENT, Y4_AXIS_ELEMENT */
  DlPlotAxisDefinition axis[5];
...
#define XLABEL_RC 8
#define YLABEL_RC 9
#define Y2LABEL_RC 10
#define Y3LABEL_RC 11
#define Y4LABEL_RC 12
...
#define FORMAT_RC 18
#define LABEL_RC 19
#define DIRECTION_RC 20
#define FILLMOD_RC 21
#define STYLE_RC 22
#define FILL_RC 23
#define CLRMOD_RC 24
#define VIS_RC 25
#define VIS_CALC_RC 26
...
#define CHAN_C_RC 29
#define CHAN_D_RC 30
#define DATA_CLR_RC 31
#define DIS_RC 32
#define XYANGLE_RC 33
#define ZANGLE_RC 34
#define PERIOD_RC 35
#define UNITS_RC 36
#define CSTYLE_RC 37
#define ERASE_OLDEST_RC 38
#define STACKING_RC 39
#define IMAGE_TYPE_RC 40
#define TEXTIX_RC 41
#define MSG_LABEL_RC 42
#define PRESS_MSG_RC 43
#define RELEASE_MSG_RC 44
#define IMAGE_NAME_RC 45
#define IMAGE_CALC_RC 46
#define DATA_RC 47
#define CMAP_RC 48
#define NAME_RC 49
#define COMPOSITE_FILE_RC 50
#define LINEWIDTH_RC 51
#define PRECISION_RC 52
#define SBIT_RC 53
#define EBIT_RC 54
#define RD_LABEL_RC 55
#define RD_VISUAL_RC 56
#define WS_FORMAT_RC 57

/* Vectors/matrices of data */
#define RDDATA_RC 58    /* Related Display data           */
#define CPDATA_RC 59    /* Cartesian Plot channel data    */
#define SCDATA_RC 60    /* Strip Chart data               */
#define SHELLDATA_RC 61 /* Shell Command data             */
#define CPAXIS_RC 62    /* Cartesian Plot axis data       */

/* Cartesian Plot entry types */
#define COUNT_RC 63      /* Cartesian Plot count           */
#define TRIGGER_RC 64    /* Cartesian Plot trigger channel */
#define ERASE_RC 65      /* Cartesian Plot erase channel   */
#define ERASE_MODE_RC 66 /* Cartesian Plot erase mode      */

/* Grid */
#define GRID_SPACING_RC 67
#define GRID_ON_RC 68
#define GRID_SNAP_RC 69
