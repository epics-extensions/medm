 ...
 */
#ifndef __WIDGETDM_H__
#define __WIDGETDM_H__
...
typedef struct {
	...
	XtPointer	triggerMonitorData;	 /* MonitorData for trigger  */
} CartesianPlotData;
 ...
 ***/
  ...
  char *elementStringTable[NUM_DL_ELEMENT_TYPES] = {
	...
	"Meter", "Text Update", "Bar", "Indicator", "Strip Chart", 
...
#define RDDATA_RC	44		/* Related Display data		  */
#define CPDATA_RC	45		/* Cartesian Plot channel data	  */
#define SCDATA_RC	46		/* Strip Chart data		  */
#define SHELLDATA_RC	47		/* Shell Command data		  */
#define CPAXIS_RC	48		/* Cartesian Plot axis data	  */

/* other new entry types */
#define TRIGGER_RC	49		/* Cartesian Plot trigger channel */

#define MIN_RESOURCE_ENTRY	0
#define MAX_RESOURCE_ENTRY	(TRIGGER_RC + 1)
 ...
 ***/
  ...
  char *resourceEntryStringTable[MAX_RESOURCE_ENTRY] = {
	...
	"Trigger",		/* Cartesian Plot trigger channel */
};
#endif
 ...
 ***/
#define MAX_RESOURCES_FOR_DL_ELEMENT 16
